package com.example.crop.crop.imagecrop.view;
...
import com.example.crop.crop.imagecrop.model.CropInfo;
import com.example.crop.crop.imagecrop.util.BitmapLoadUtils;
import com.example.crop.crop.imagecrop.view.graphics.FastBitmapDrawable;
...
public class ImageCropView extends ImageView {
    ...
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#000000";
